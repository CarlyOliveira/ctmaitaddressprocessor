package br.com.ctmait.addressprocessor.deprecated.domain.models;
...
public class Address {
    ...
    public Address(UUID id, String cep, String logradouro, String complemento, String bairro, String localidade, String uf, String numero) {
        this.id = id;
        this.cep = cep;
